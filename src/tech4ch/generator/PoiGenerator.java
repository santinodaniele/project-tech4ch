...
public class PoiGenerator {
	...
	public ArrayList<Poi> initPois() {
		...
		poiList.add(persianCult);
		poiList.add(jerusalemPhoto);
		
		poiList.add(museumMotto);
		poiList.add(entranceGallileeRebellion);
		poiList.add(duckBoxIvories);
		poiList.add(canaaniteStelae);
		poiList.add(ivoryWomanPhoenician);
		poiList.add(clayAmphorae);
		poiList.add(animalModels);
		poiList.add(elevator1);
		
		poiList.add(stairsToBathroom);
		poiList.add(bronzeTools);
		poiList.add(stoneVesselsBowl);
		poiList.add(mosaicfromSynagogue);
		poiList.add(glassOvenVessels);
		poiList.add(woodenTools);
		
		poiList.add(phoenicians);
		poiList.add(importedPottery);
		poiList.add(craftsAndArts);
		poiList.add(religionAndCult);
		poiList.add(everydayPottery);
		poiList.add(phoenicianWriting1);
		poiList.add(burialTradition2);
		poiList.add(maritimeCommerce);
		poiList.add(buildingMethodsAndFacilities);
		
		poiList.add(shipEntrance);
		poiList.add(shipFront);
		poiList.add(shipBack);
		poiList.add(maritimeArcheology);
		poiList.add(pottery);
		poiList.add(carpenterTools);
		
		poiList.add(coins);
		poiList.add(sevenSpecies);
		poiList.add(weights);
		poiList.add(greeceEgypt);
		poiList.add(gems);
		poiList.add(cyprus);
		poiList.add(jerusalem);
		poiList.add(templeMount);
		poiList.add(oilLamps);
		poiList.add(upperFloorEntrance);
		...
		poiList.add(decoratedDoors);
		poiList.add(menorahJewishEpigraphy);
		poiList.add(romanDivinitiesStatuettes);
