...
import tech4ch.generator.GraphGenerator;
import tech4ch.generator.MuseumGenerator;
...
public class TestDijkstra {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		poiList.add(new Poi("TempleMount", 843, 117));
		poiList.add(new Poi("JerusalemPhoto", 501, 486));
		poiList.add(new Poi("AnimalModels", 620, 186));
		//poiList.add(new Poi("PhoenicianWriting1", 290, 358));
		//poiList.add(new Poi("GreeceEgypt", 975, 133));
		//poiList.add(new Poi("DecoratedDoors", 529, 419));
		//poiList.add(new Poi("SevenSpecies", 839, 226));
		//poiList.add(new Poi("MaritimeArcheology", 23, 181));
		//poiList.add(new Poi("JerusalemPhoto", 501, 486));
		//poiList.add(new Poi("AnimalModels", 620, 186));
		//poiList.add(new Poi("PhoenicianWriting1", 290, 358));
		//poiList.add(new Poi("GreeceEgypt", 975, 133));
		...
		for(Node node : path) {
			System.out.print(node.getNodePosition().getCoord()[0]);
			System.out.print("\t");
			System.out.print(node.getNodePosition().getCoord()[1]);
			System.out.print("\n");
		}
	}
